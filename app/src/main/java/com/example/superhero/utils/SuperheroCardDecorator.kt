...
/*აგვარებს ვიუებს(ქარდებს) შორის დაშორების პრობლემას*/
class SuperheroCardDecorator(
    // დაშორებები
    @Dimension
...
//გადმოეცემა ვიუს მონაცემები, სად ზის ეს ვიუ და  outRect: Rect <-- ვიუს კორდინატები
// State <-- რა მდგომარეობაშია RecyclerView
